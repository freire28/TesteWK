...
uses
  System.SysUtils, System.Classes, REST.Types, REST.Client,REST.Json, System.JSON,
...
begin
  ...
  FDQAuxCEP1.SQL.Add('select a.idendereco, a.dscep from endereco a where a.idendereco not in (select b.idendereco from endereco_integracao b)');
  FDQAuxCEP1.Open();
    ...
    begin
      ...
      try
       ...
       // jsonArray :=  jsonPair.JsonValue as TJSONArray;
        ...
        FDQEnderecoIntegracao.FielDByName('idendereco').AsInteger := FDQAuxCEP1.FieldByName('idendereco').AsInteger;
        FDQEnderecoIntegracao.FielDByName('dsuf').AsString := endereco.uf;
        FDQEnderecoIntegracao.FielDByName('nmcidade').AsString := endereco.localidade;
        FDQEnderecoIntegracao.FielDByName('nmbairro').AsString := endereco.bairro;
        FDQEnderecoIntegracao.FielDByName('nmlogradouro').AsString := endereco.logradouro;
        FDQEnderecoIntegracao.FielDByName('dscomplemento').AsString := endereco.complemento;
